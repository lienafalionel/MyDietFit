...
public class UtilisateursActivity extends Activity {
	    ...
	    public static final String strURL = "http://mad1.byethost15.com/utilisateurs.php";
	    ...
	    class DownTask extends AsyncTask<String, Void, String> {
	    	...
	    	protected String doInBackground(String... params) {
	            ...
	            try{
	                ...
	                for(int i=0;i<jArray.length();i++){
	                    ...
	                    Log.i("log_tag","idUtilisateur: "+json_data.getInt("idUtilisateur")+
	                            ", Nom_utilisateur: "+json_data.getString("nom")
	                    );
	    	...
	    	protected void onPostExecute(String result) {
	    		if(result == null) {
	    			txt.setText("Login ou mot de passe incorrect");
	    		} else {
	    			txt.setText(result);
	    			try {
						Thread.sleep(5000);
